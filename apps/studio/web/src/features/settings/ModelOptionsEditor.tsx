      ...
      state: EditorState.create({
        ...
        extensions: [
          ...
          EditorView.theme({
            ...
            '.cm-scroller': { fontFamily: 'var(--font-code)', lineHeight: 'var(--type-meta-line)', maxHeight: 'calc(var(--space-12) * 5)', overflow: 'auto' },
            ...
            '.cm-tooltip': { backgroundColor: 'var(--color-layer-1)', color: 'var(--color-text-primary)', borderColor: 'var(--color-border)', borderRadius: 'var(--radius-md)' },
