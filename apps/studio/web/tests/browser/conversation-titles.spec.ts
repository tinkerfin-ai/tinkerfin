  ...
  await page.addInitScript(({ theme }) => {
    ...
    window.fetch = async (input, init) => {
      ...
      if (url.pathname.endsWith('/history')) {
        ...
        return json({ ...titles.get(threadId), id: 1, lastModel: 'main', pinned: false, asOfSeq: 0, generation: 'test', observedAt: '2026-09-08T00:00:00.000000Z', headRunId: stream.runId, availableHeads: [stream.runId], historyCursor: null, messageCount: 0, toolCallCount: 0, messages: [], reasoning: [], state: { root: {}, subgraphs: {} }, interactions: [], status: { execution: 'succeeded', headRunId: stream.runId }, completeness: { missingPrefix: false, missingTail: false, payloadOmitted: false }, createdAt: '2026-09-08T00:00:00Z', updatedAt: '2026-09-08T00:00:00Z', graph: { asOfSeq: 0, turns: [], nodes: [], orderedNodeIds: [], matchedNodeIds: [], completeness: { callTrackingMissing: false, relationshipEvidenceMissing: false, detailsOmitted: false } }, taskTrace: url.searchParams.get('includeTaskTrace') === 'true' ? { status: 'ready', todoGroups: [] } : null })
      }
      return json({})
    }
  }, { theme })
