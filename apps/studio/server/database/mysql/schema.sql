...
CREATE TABLE conversation_threads (
  ...
  snapshot_seq BIGINT NOT NULL COMMENT 'v2 快照覆盖到的序号',
  snapshot_version INTEGER NOT NULL COMMENT '快照结构版本，当前固定为 2',
...
CREATE TABLE conversation_runs (
  ...
  run_id VARCHAR(128) NOT NULL COMMENT 'AG-UI run ID',
  parent_run_id VARCHAR(128) COMMENT '标准 AG-UI parentRunId',
  parent_agent_run_id VARCHAR(128) COMMENT '扩展的父 Agent run ID',
...
CREATE TABLE conversation_events (
  ...
  schema_version INTEGER NOT NULL COMMENT 'Studio 事件结构版本',
