"""Immutable capacity limits for in-memory semantic tracing."""
...
class TraceLimits(TraceModel):
    """Bound event and aggregate memory before accepting Trace facts."""
    ...
    max_tracer_threads: int = Field(default=10_000, ge=1)
    max_tracer_bytes: int = Field(default=1024 * 1024 * 1024, ge=64 * 1024)
